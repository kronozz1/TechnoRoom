    ...
    <section className="BlogSection flex flex-column items-center gap-xl">
      <div className="BlogSection__content">
        <Text variant="h1" weight="bold">
          Welcome to TechnoPlace: Technology Preview
        </Text>
        ...
        <Text variant="c1">
          ...
          excited today to finally publicly debut our first Technology Preview of TechnoPlace - a beautiful new web
          client for connecting to shared 3D (or 2D) spatial environments and applications built on Matrix.
        </Text>
        <Text variant="c1">
          TechnoPlace lets you use Matrix as the platform for a truly free and open decentralised vision of the metaverse
          ...
          cryptocurrencies, NFTs, or data-hoarding big tech silos. In other words: TechnoPlace will be a blank canvas for
        ...
        <ul>
          ...
          <li>
            <a href="#what-makes-us-unique">What makes TechnoPlace unique?</a>
          </li>
          <li>
        ...
        <Text variant="c1">
          We see TechnoPlace as a logical extension to today’s Matrix clients. The starting point for a Matrix room is of
        ...
        <Text variant="c1">
          The point of today’s tech preview is to show off the capabilities of TechnoPlace’s engine and spark interest
          ...
          said, there’s obviously some stuff already here for you to play with! To get going, head over to{" "}
           in a modern desktop browser and log in as a guest or
        ...
        <Text variant="c1">
          TechnoPlace is built on a new browser-based engine that we’ve built called{" "}
          <a
        ...
        <Text variant="c1">In terms of features, TechnoPlace Technology Preview 1 provides support for:</Text>
        <ul>
        ...
        <ul className="BlogSection__spaced-list">
          ...
          <li>
            <span className="semi-bold">User Generated Content:</span> The vision is of course for TechnoPlace to be a
          ...
          <li>
            ...
            glTF blobs into the Matrix room (as plain old files, so that boring old Matrix bots or non-TechnoPlace
          ...
          <li>
            ...
            landed yet (and once we’ve got it working in Element Call, we’ll have to port it over to Hydrogen for TechnoPlace to use).
          </li>
        ...
        <Text id="what-makes-us-unique" variant="h2" weight="semi-bold">
          What makes TechnoPlace unique?
        </Text>
        <Text variant="c1">
          There’s obviously been way too much hype about virtual worlds and the metaverse recently, so it’s important to
          spell out what makes TechnoPlace unique.
        </Text>

        <ul className="BlogSection__spaced-list">
          <li>
            <span className="semi-bold">Web first.</span> TechnoPlace aspires to be the real-time spatial layer of the
            ...
            the metaverse seem to involve installing enormous proprietary Windows-only native apps via Steam,TechnoPlace 
            ...
            instance, TechnoPlace runs fine on a 2010 Macbook Air with integrated graphics. Today’s release is desktop
            web only, but mobile web is not far away (and performance is great!). Obviously there’s nothing stopping
            people from also building TechnoPlace compatible native clients too (same as for normal Matrix) - and we hope
            to see Godot, Unity and Unreal clients emerge in due course! But our roots will always be on the open Web.
          </li>
          <li>
            <span className="semi-bold">Open standards throughout.</span> Building on Matrix means that TechnoPlace
            ...
            . However, to actually describe and model the 3D assets in TechnoPlace, we are using{" "}
            ...
            <br />
            Meanwhile, while building TechnoPlace we’ve found ourselves repeatedly hitting the edge of the possible in
          ...
          <li>
            <span className="semi-bold">Open Source.</span> It should be no surprise that TechnoPlace is entirely{" "}
            ...
            cementing it as a foundation that everyone can build on. Finally, TechnoPlace is proud to build on a set of
            ...
            amazing things on top of TechnoPlace in turn!
          </li>
          <li>
            ...
            a result, there is no artificial scarcity in TechnoPlace, or virtual real-estate speculation, or intrinsic
          ...
          <li>
            <span className="semi-bold">Aesthetically beautiful.</span> We’re determined that TechnoPlace’s engine should
          ...
          <li>
            ...
            smartphone screens, and we want TechnoPlace to be amazing for the mainstream audience. As a result, our
            primary platform for TechnoPlace is unashamedly the plain old web browser as viewed on a flat screen -
        ...
        <Text variant="c1">
          It’s worth reiterating that TechnoPlace does not have its own server - it is powered exclusively by plain old
          Matrix homeservers, with no new APIs or functionality required whatsoever. As a result, anyone running their
          own Synapse, Dendrite, Conduit or Construct can go and point TechnoPlace at it and jump straight in. In return,
          TechnoPlace inherits a tonne of amazing features directly from Matrix:
        </Text>
        ...
        <ul className="BlogSection__spaced-list">
          <li>
            ...
            <br />
            The one exception to this in TechnoPlace is the physics engine: currently, objects are ‘owned’ by the account
          ...
          <li>
            <span className="semi-bold">VoIP:</span> TechnoPlace uses{" "}
            <a
              href="https://github.com/matrix-org/matrix-spec-proposals/pull/3401"
              target="_blank"
              rel="noreferrer noopener"
            ...
            coming into its own to power TechnoPlace.
          </li>
          <li>
            <span className="semi-bold">E2EE:</span> TechnoPlace is the only end-to-end encrypted metaverse client in
          ...
          <li>
            ...
            authentication, and TechnoPlace is the world’s first ever OIDC-native Matrix app. It implements{" "}
            <a
            ...
            to your identity provider. For the TechnoPlace server, we’ve set up a TechnoPlace branded Keycloak instance
            ...
            TechnoPlace’s development, and a huge relief to know that in future we will never have to implement our own
        ...
        <ul>
          ...
          <li>Art and Design - get building 3D or 2D models and artwork directly in TechnoPlace!</li>
          <li>Gaming - the entire spectrum of multiplayer gaming could exist in TechnoPlace</li>
          <li>
        ...
        <Text variant="c1">
          ...
          interactive spatial application to be able to exist in TechnoPlace - building directly on Matrix’s existing
        ...
        <Text variant="c1">
          The fact is that TechnoPlace has been put together by a tiny team of just Robert (project lead, formerly of
        ...
        <Text variant="c1">
          Also, it’s worth noting that at Element we’ve been showing off TechnoPlace as it develops to a lot of our big
          customers - and in practice there is significant interest from many of our big public sector deployments to
          experiment with TechnoPalace. We are depending on commercial interest to scale up work on TechnoPlace - please
        ...
        <Text variant="c1">
          Our next main milestone is to release a minimum viable product (MVP) version of TechnoPlace which a mainstream
          ...
          year, but meanwhile we’ll continuously deploying TechnoPlace off the main branch of the repository.
        </Text>
        <Text variant="c1">
          It might also be interesting to see whether TechnoPlace can embed in Element using the same{" "}
          <a
          ...
          other widget-capable Matrix client), why shouldn’t you just be able to reach straight into TechnoPlace? This
        ...
        <Text variant="c1">
          ...
          to help build out beautiful avatars, scenes, assets, and generally ensure that TechnoPlace sets a precedent for
        ...
        <Text variant="c1">
          We live in exciting times: it will be fascinating to see how TechnoPlace progresses, and whether it really
